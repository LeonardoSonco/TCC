                ...
                {campaigns ? (
                    <>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <FormControl sx={{ m: 1, minWidth: 120, maxWidth: 128, margin: 0, marginY: 1 }} size="small">
                        ...
                        {campaignSelected && renderInputParametersCampaign(customParametersCampaing)}
                        <div className="my-10">
                            <form className={``}>
