    ...
    <div className="col-span-5">
      ...
      <div className="pl-4 flex flex-col gap-4">
        <p>
          ...
          funcionando em sua máquina local para fins de desenvolvimento e teste.
        </p>
        <p>
          Para começar, a máquina que irá executar esta aplicação deve ter os
          seguintes requisitos:
        </p>
        <ul className="list-disc pl-14 max-mobile:pl-4">
          <li>
            Sistema operacional Linux (por exemplo, Ubuntu, Debian e outros...)
            (MacOS/Windows é experimental)
          </li>
          ...
          <li>
            <a href="https://docs.docker.com/get-docker/">Docker</a> instalado
          </li>
        </ul>
      </div>
      ...
      <div className="pl-4 flex flex-col gap-4 ">
        <div>
          <p className="pb-3">
            Usando seu terminal, clone este repositório em sua máquina local
            usando Git:
          </p>
